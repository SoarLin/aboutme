    ...
    $.widget( "mobile.lazyloader", $.mobile.widget, {
        ...
        _check : function( threshold ) {
            ...
            if ( this._instances[this._settings.pageId] ) {
                ...
                if( totalHeight > $('#'+this._settings.pageId).height() )totalHeight = $('#'+this._settings.pageId).height();
                                            ...
                                            success: function( data ){
                                                ...
                                                try {
                                                    ...
                                                    if ( count > 0 ) {
                                                        ...
                                                        callback = $that._instances[$that._settings.pageId]['settings'].callback;
        ...
        reset : function( pageId ) {
            ...
            if( !$that._settings.clearUrl )return _reset(1);
